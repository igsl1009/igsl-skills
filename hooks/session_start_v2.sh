...
# ── 4b. Write t1_session.mem with live values ────────────────────────────────
cat > "$MEM/t1_session.mem" << T1MEM
# T1 Session Block — refreshed each session (~50 tokens)
# Generated by session_start_v2.sh — do not edit manually
