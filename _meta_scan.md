...
## HARD SKILLS (auto-loaded every session)
  [META-05     ] auto-improve             280tok  h=0.85  Always-on. Session journal, captures corrections, propo
  [META-07     ] memory-system            180tok  h=0.85  Always-on. Memory write protocol: node.py add/update/cl
